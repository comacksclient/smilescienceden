          ...
          <div className="flex items-center gap-4">
            ...
            <div className="lg:hidden flex items-center gap-2">
              <a
                ...
                // CHANGED: w-9 h-9 -> w-11 h-11 for better touch target
                className="w-11 h-11 flex items-center justify-center rounded-full bg-[#1d5343] text-white shadow-md active:scale-95 transition-transform"
              >
                <WhatsAppIcon />
              </a>
              ...
              <button
                ...
                // CHANGED: w-9 h-9 -> w-11 h-11 for better touch target
                className="w-11 h-11 flex items-center justify-center rounded-full bg-white border border-gray-200 text-[#1A1A1A] active:scale-95 transition-transform hover:bg-gray-50"
              >
